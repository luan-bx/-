                ...
                for (String obj : monitors) {
                    ...
                    if (paramStr.contains("DataTime") || flag) {
                        ...
                        if(!flag){
                            ...
                            SimpleDateFormat timeFormat = new java.text.SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
                            java.util.Date date = formatter.parse(dataTime2);
...
//
        System.out.println(checkData("##0625QN=20230411170737004;ST=32;CN=2051;PW=123456;MN=65493463201040;Flag=5;CP=&&DataTime=20230411165000;w01018-Cou=0.0,w01018-Avg=359.7,w01018-Min=359.7,w01018-Max=359.7,w01018-Flag=N;w21003-Cou=0.00,w21003-Avg=11.42,w21003-Min=11.42,w21003-Max=11.42,w21003-Flag=N;w21011-Cou=0.00,w21011-Avg=0.45,w21011-Min=0.45,w21011-Max=0.45,w21011-Flag=N;w21001-Cou=0.00,w21001-Avg=16.42,w21001-Min=16.42,w21001-Max=16.42,w21001-Flag=N;w00000-Cou=0.03,w00000-Avg=0.01,w00000-Min=0.00,w00000-Max=0.21,w00000-Flag=N;w01001-Avg=6.71,w01001-Min=6.69,w01001-Max=6.74,w01001-Flag=N;w01010-Avg=24.02,w01010-Min=24.00,w01010-Max=24.10,w01010-Flag=N&&0A00\r\n"));
