...
import com.shark.aio.data.electricityData.mapper.ElectricityMapping;
...
public class ElectricityService {
    @Autowired
    private ElectricityMapping electricityMapping;
    ...
    public List<String> getAllMonitor(){
        try {
            List<String> allMonitor = electricityMapping.getAllMonitor();
            return allMonitor;
        }catch (Exception e){
            log.error("ElectricityService/getAllMonitor:获取全部监测点失败！",e);
            return null;
        }
    }
