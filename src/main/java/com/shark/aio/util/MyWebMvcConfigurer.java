...
public class MyWebMvcConfigurer extends WebMvcConfigurationSupport{
	...
	*/
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
		...
		registry.addResourceHandler("/faceResultPath/**").addResourceLocations("file:D:/images/faceResult/");
		registry.addResourceHandler("/carResultPath/**").addResourceLocations("file:D:/images/carResult/");
    }
