...
public class AlarmService {
    ...
    public List<String> getAllCompanyMedium(){
        try {
            List<String> allCompany = alarmMapping.getAllCompanyMedium();
            return allCompany;
        }catch (Exception e){
            log.error("获取全部企业名称失败！",e);
            return null;
    ...
    public List<String> getAllCompanyHigh(){
        try {
            List<String> allCompany = alarmMapping.getAllCompanyHigh();
            return allCompany;
        }catch (Exception e){
            log.error("获取全部企业名称失败！",e);
            return null;
    ...
    public boolean setAttributeMedium(HttpServletRequest request){
        ...
        List<String> allMonitor = getAllMonitor();
        List<String> allCompany = getAllCompanyMedium();
    ...
    public boolean setAttributeHigh(HttpServletRequest request){
        List<String> allPollutionName = getAllPollutionName();
        List<String> allCompany = getAllCompanyHigh();
